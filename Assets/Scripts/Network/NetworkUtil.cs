...
public class NetworkUtil
 {
    ...
    #region 重定位
    public static string GetRelocateUrlSuffix(SummaryItemData summaryItemData)
    {
        ...
        return "media_app/" + relocate_algo;
    }
    ...
    {
        string relocateRequestSuffixInterface = GetRelocateUrlSuffix(summaryItemData) + "/?source_location=";
    ...
    public IEnumerator TempRelocate()
    {
        return null;
    }
